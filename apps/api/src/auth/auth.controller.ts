...
export class AuthController {
  ...
  @CaptchaAction('register')
  @HttpCode(HttpStatus.NO_CONTENT)
  resendConfirmation(@Body() body: AuthResendConfirmationDto): Promise<void> {
    return this.service.resendConfirmation(body.email);
  }
  ...
  @Post('refresh')
  @UseGuards(AuthProtectionGuard, AuthGuard('jwt-refresh'))
  @HttpCode(HttpStatus.OK)
  public refresh(
